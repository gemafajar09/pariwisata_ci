				...
				<div class="card">
					<div class="card-body">
						<div class="row">
							...
							<div class="col-md-8">
								Lorem ipsum dolor sit amet consectetur adipisicing elit. Labore necessitatibus non
								aperiam consectetur illum obcaecati, quos officia cupiditate tempora facere unde
								temporibus tempore! Cupiditate corrupti reiciendis a modi odio error!
								<br>
								<br>
